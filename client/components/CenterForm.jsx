...
class CenterForm extends React.Component {
  ...
  render() {
    const { fetching, userType, userLogoutFunc, type, loggedIn, centerId, centerFieldError, closeInfoTabFunc, closeModalFunc, updateCenterFieldFunc, updateCenterFunc, center, resetFunc, createCenterFunc, showInfoTab, infoTabMsg } = this.props;
                    ...
                    <div className='container-fluid'>
                      <div className='row'>
                        ...
                        <div className="space-top col-md-6">
                          ...
                          <input type="text" value={center.centerRate || ''} id="inputCenterRate" placeholder="per day" className={
