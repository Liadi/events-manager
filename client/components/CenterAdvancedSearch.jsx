    ...
    <div id= "advancedSearchFrame">
      <div className="form-row">    
        <div className="form-group col-md-2">
          ...
          <input type="text" value={center.centerCountry || ''} className= "form-control form-control-sm" id="searchCountry" placeholder="Nigeria" disabled onChange={ e => {
            updateCenterFieldFunc('centerCountry', e.target.value.trim());
          }}/>
        </div>
        <div className="form-group col-md-2">
          <label htmlFor="searchState" className="form-label-sm">State</label>
          <input type="text" value={center.centerState || ''} className="form-control form-control-sm" id="searchState" onChange={ e => {
            updateCenterFieldFunc('centerState', e.target.value.trim());
          }}/>
        </div>
        <div className="form-group col-md-2">
          <label htmlFor="searchCity" className="form-label-sm">City</label>
          <input type="text" value={center.centerCity || ''} className="form-control form-control-sm" id="searchCity" onChange={ e => {
        ...
        <div className="form-group col-md-2">
          ...
          <input type="text" value={center.centerCapacity || ''} className="form-control form-control-sm" id="searchCapacity" onChange={ e => {
      ...
      {props.loggedIn?(
        <div className='form-row'>
          ...
          <div className="form-group col-md-2">
            ...
            <input type="text" value={center.centerPriceLower || ''} className="form-control form-control-sm" placeholder='Lower' id="searchPriceLower" onChange={ e => {
              if (String(parseInt(e.target.value)) === e.target.value || e.target.value === "") {
          ...
          <div className="form-group col-md-2">
            ...
            <input type="text" value={center.centerPriceUpper || ''} className="form-control form-control-sm" placeholder='Upper' id="searchPriceUpper" onChange={ e => {
              if (String(parseInt(e.target.value)) === e.target.value || e.target.value === "") {
